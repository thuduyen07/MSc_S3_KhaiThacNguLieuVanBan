...
def main():
    ...
    parser.add_argument('prompt', nargs='?', type=str, default='a pikachu in a forest')
    parser.add_argument('--action', '-a', type=str, choices=actions, default=actions[0])
    parser.add_argument('--low-memory', action='store_true')
    parser.add_argument('--model', type=str, default='sd-pokemon-diffusers', choices=list(model_id_map.keys()))
